...
namespace VSharp
{
    ...
    public class Lexer(string input)
    {
        ...
        {
            { "stack", TokenType.KeywordSet },
            { "fr", TokenType.KeywordIf },
            { "nah", TokenType.KeywordElse },
            { "sigmaelse", TokenType.LogicalOr },
            { "plusRizz", TokenType.LogicalAnd },
            { "loopin", TokenType.KeywordWhile},
            { "rizz", TokenType.KeywordFunc},
            { "grind", TokenType.KeywordFor},
            { "clout", TokenType.KeywordIn },
            { "vomit", TokenType.KeywordReturn },
            { "brostop", TokenType.KeywordBreak },
            { "moveon", TokenType.KeywordContinue },
            { "rizzed", TokenType.KeywordTrue },
            { "flopped", TokenType.KeywordFalse },
            { "clouttype", TokenType.KeywordType },
            { "frfr", TokenType.KeywordIs },
            { "gyat", TokenType.KeywordAs },
            { "grab", TokenType.KeywordImport },
            { "outlandish", TokenType.KeywordLib },
            {"flipflop",TokenType.KeywordSwitch },
            {"drippick",TokenType.KeywordCase },
            {"baserizz",TokenType.KeywordDefault},
            {"grinduntil",TokenType.KeywordUntil },
            {"eat",TokenType.KeywordUse },
        };
